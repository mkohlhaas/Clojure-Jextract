...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        time_h.C_INT.withName("tm_sec"),
        time_h.C_INT.withName("tm_min"),
        time_h.C_INT.withName("tm_hour"),
        time_h.C_INT.withName("tm_mday"),
        time_h.C_INT.withName("tm_mon"),
        time_h.C_INT.withName("tm_year"),
        time_h.C_INT.withName("tm_wday"),
        time_h.C_INT.withName("tm_yday"),
        time_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        time_h.C_LONG.withName("tm_gmtoff"),
        time_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
